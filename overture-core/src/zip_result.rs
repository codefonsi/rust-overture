...
/// ```
pub fn zip3_with<A, B, C, Z, E, F>(transform: F, a: Result<A, E>, b: Result<B, E>, c: Result<C, E>) -> Result<Z, E>
where
    F: FnOnce(A, B, C) -> Z,
{
    a.and_then(|a| {
...
pub fn zip4<A, B, C, D, E>(a: Result<A, E>, b: Result<B, E>, c: Result<C, E>, d: Result<D, E>) -> Result<(A, B, C, D), E> {
    a.and_then(|a| {
        b.and_then(|b| {
            c.and_then(|c| {
                d.map(|d| (a, b, c, d))
...
pub fn zip4_with<A, B, C, D, Z, E, F>(transform: F, a: Result<A, E>, b: Result<B, E>, c: Result<C, E>, d: Result<D, E>) -> Result<Z, E>
where
    F: FnOnce(A, B, C, D) -> Z,
{
    a.and_then(|a| {
...
pub fn zip5<A, B, C, D, E, F>(a: Result<A, F>, b: Result<B, F>, c: Result<C, F>, d: Result<D, F>, e: Result<E, F>) -> Result<(A, B, C, D, E), F> {
    a.and_then(|a| {
        b.and_then(|b| {
            c.and_then(|c| {
                d.and_then(|d| {
...
pub fn zip5_with<A, B, C, D, E, Z, F, G>(transform: G, a: Result<A, F>, b: Result<B, F>, c: Result<C, F>, d: Result<D, F>, e: Result<E, F>) -> Result<Z, F>
where
...
pub fn zip6<A, B, C, D, E, F, G>(a: Result<A, G>, b: Result<B, G>, c: Result<C, G>, d: Result<D, G>, e: Result<E, G>, f: Result<F, G>) -> Result<(A, B, C, D, E, F), G> {
    a.and_then(|a| {
        b.and_then(|b| {
            c.and_then(|c| {
                d.and_then(|d| {
...
pub fn zip6_with<A, B, C, D, E, F, Z, G, H>(transform: H, a: Result<A, G>, b: Result<B, G>, c: Result<C, G>, d: Result<D, G>, e: Result<E, G>, f: Result<F, G>) -> Result<Z, G>
where
...
pub fn zip7<A, B, C, D, E, F, G, H>(a: Result<A, H>, b: Result<B, H>, c: Result<C, H>, d: Result<D, H>, e: Result<E, H>, f: Result<F, H>, g: Result<G, H>) -> Result<(A, B, C, D, E, F, G), H> {
    a.and_then(|a| {
        b.and_then(|b| {
            c.and_then(|c| {
                d.and_then(|d| {
...
pub fn zip7_with<A, B, C, D, E, F, G, Z, H, I>(transform: I, a: Result<A, H>, b: Result<B, H>, c: Result<C, H>, d: Result<D, H>, e: Result<E, H>, f: Result<F, H>, g: Result<G, H>) -> Result<Z, H>
where
...
pub fn zip8<A, B, C, D, E, F, G, H, I>(a: Result<A, I>, b: Result<B, I>, c: Result<C, I>, d: Result<D, I>, e: Result<E, I>, f: Result<F, I>, g: Result<G, I>, h: Result<H, I>) -> Result<(A, B, C, D, E, F, G, H), I> {
    a.and_then(|a| {
        b.and_then(|b| {
            c.and_then(|c| {
                d.and_then(|d| {
...
pub fn zip8_with<A, B, C, D, E, F, G, H, Z, I, J>(transform: J, a: Result<A, I>, b: Result<B, I>, c: Result<C, I>, d: Result<D, I>, e: Result<E, I>, f: Result<F, I>, g: Result<G, I>, h: Result<H, I>) -> Result<Z, I>
where
...
pub fn zip9<A, B, C, D, E, F, G, H, I, J>(a: Result<A, J>, b: Result<B, J>, c: Result<C, J>, d: Result<D, J>, e: Result<E, J>, f: Result<F, J>, g: Result<G, J>, h: Result<H, J>, i: Result<I, J>) -> Result<(A, B, C, D, E, F, G, H, I), J> {
    a.and_then(|a| {
        b.and_then(|b| {
            c.and_then(|c| {
                d.and_then(|d| {
...
pub fn zip9_with<A, B, C, D, E, F, G, H, I, Z, J, K>(transform: K, a: Result<A, J>, b: Result<B, J>, c: Result<C, J>, d: Result<D, J>, e: Result<E, J>, f: Result<F, J>, g: Result<G, J>, h: Result<H, J>, i: Result<I, J>) -> Result<Z, J>
where
...
pub fn zip10<A, B, C, D, E, F, G, H, I, J, K>(a: Result<A, K>, b: Result<B, K>, c: Result<C, K>, d: Result<D, K>, e: Result<E, K>, f: Result<F, K>, g: Result<G, K>, h: Result<H, K>, i: Result<I, K>, j: Result<J, K>) -> Result<(A, B, C, D, E, F, G, H, I, J), K> {
    a.and_then(|a| {
        b.and_then(|b| {
            c.and_then(|c| {
                d.and_then(|d| {
...
pub fn zip10_with<A, B, C, D, E, F, G, H, I, J, Z, K, L>(transform: L, a: Result<A, K>, b: Result<B, K>, c: Result<C, K>, d: Result<D, K>, e: Result<E, K>, f: Result<F, K>, g: Result<G, K>, h: Result<H, K>, i: Result<I, K>, j: Result<J, K>) -> Result<Z, K>
where
...
mod tests {
    ...
    fn test_zip_with_strings() {
        ...
        assert_eq!(result, Ok("Alice is 25 years old and lives in New York".to_string()));
    }
